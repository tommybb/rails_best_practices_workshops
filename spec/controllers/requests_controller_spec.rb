  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved request as @request" do
        ...
        post :create, {:request => { "user_id" => "invalid value" }}, valid_session
        expect(assigns(:request)).to be_a_new(Request)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested request" do
        ...
        expect_any_instance_of(Request).to receive(:update).with({ "user_id" => "" })
        put :update, {:id => request.to_param, :request => { "user_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the request as @request" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Request.any_instance.stub(:save).and_return(false)
        put :update, {:id => request.to_param, :request => { "user_id" => "invalid value" }}, valid_session
        expect(assigns(:request)).to eq(request)
      end
