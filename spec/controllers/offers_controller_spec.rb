  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved offer as @offer" do
        ...
        post :create, {:offer => { "user_id" => "invalid value" }}, valid_session
        expect(assigns(:offer)).to be_a_new(Offer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested offer" do
        ...
        expect_any_instance_of(Offer).to receive(:update).with({ "user_id" => "" })
        put :update, {:id => offer.to_param, :offer => { "user_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the offer as @offer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Offer.any_instance.stub(:save).and_return(false)
        put :update, {:id => offer.to_param, :offer => { "user_id" => "invalid value" }}, valid_session
        expect(assigns(:offer)).to eq(offer)
      end
